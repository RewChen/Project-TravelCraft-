import { Mail, Key, Play } from 'lucide-react';
...
export default function LoginForm() {
  ...
  return (
    <form onSubmit={login} className="space-y-3">
      ...
      <button 
        type="submit" 
        className="w-full bg-[#cc0000] text-white font-bold py-2 px-4 rounded border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-y-0.5 text-xs uppercase flex items-center justify-center gap-2 cursor-pointer hover:bg-red-700 transition-colors"
      >
