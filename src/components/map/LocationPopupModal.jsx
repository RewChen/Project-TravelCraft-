...
import { X, Heart, Trash2, Camera, Clock3, ExternalLink, AlertTriangle } from 'lucide-react';
        ...
        <div className="flex justify-between items-center pt-1 border-t-2 border-black">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="bg-amber-100 hover:bg-amber-200 text-amber-900 text-[10px] font-black px-2.5 py-1.5 border-2 border-black rounded shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] uppercase flex items-center gap-1 cursor-pointer"
            >
