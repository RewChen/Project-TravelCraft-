    ...
    <div className="max-w-6xl mx-auto px-4 pb-12">
        ...
        <div className="bg-[#a2d2ff] relative min-h-[260px] flex flex-col justify-between p-4 bg-[radial-gradient(#4895ef_1px,transparent_1px)] [background-size:16px_16px]">
          ...
          <div className="my-auto bg-[#81c784] border-4 border-black rounded-lg p-3 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            <div className="text-[10px] font-bold text-emerald-950 uppercase mb-2 flex items-center justify-between">
              ...
              <span className="animate-pulse text-red-600">{t('home.live')}</span>
            </div>
      ...
      <section className="bg-gray-200 dark:bg-slate-800 border-4 border-black rounded-2xl p-6 md:p-8 mb-12 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          ...
          {[
            { step: 1, color: 'bg-red-600', icon: Search, titleKey: 'home.discoverTitle', descKey: 'home.discoverDesc' },
            { step: 2, color: 'bg-amber-400', icon: Footprints, titleKey: 'home.trackTitle', descKey: 'home.trackDesc' },
            { step: 3, color: 'bg-blue-600', icon: ArrowUp, titleKey: 'home.levelTitle', descKey: 'home.levelDesc' }
          ].map((item) => (
