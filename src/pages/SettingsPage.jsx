...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pb-12 space-y-6 font-mono">
      {/* Header */}
      <div className="bg-white dark:bg-slate-800 border-4 border-black rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-black uppercase tracking-tight text-slate-900 dark:text-slate-100">{t('settings.title')}</h1>
      ...
      <div className="bg-white dark:bg-slate-800 border-4 border-black rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h2 className="text-base font-black uppercase text-slate-900 dark:text-slate-100">{t('settings.language')}</h2>
        </div>
            ...
            return (
              ...
              >
                <span className="flex items-center gap-3">
                  ...
                  <span>
                    <span className={`block text-sm font-black uppercase ${!isActive ? 'dark:text-slate-100' : ''}`}>{lang.native}</span>
      ...
      <div className="bg-white dark:bg-slate-800 border-4 border-black rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h2 className="text-base font-black uppercase text-slate-900 dark:text-slate-100">{t('settings.theme')}</h2>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className={`flex items-center justify-center gap-2 px-4 py-3 border-2 border-black rounded-lg transition-all cursor-pointer font-black text-xs uppercase ${
              !isDark
                ? 'bg-amber-400 text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]'
                : 'bg-gray-50 hover:bg-gray-100 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-100'
            }`}
          >
